...
describe('Dashboard', () => {
    it('should be able to list all the food plates from your api', async () => {
        ...
        expect(getByText('Macarrão com pimentão, ervilha e ervas finas colhidas no himalaia.')).toBeTruthy();
        ...
        expect(getByText('Macarrão com vegetais de primeira linha e camarão dos 7 mares.')).toBeTruthy();
    ...
    it('should be able to add a new food plate', async () => {
        ...
        expect(inputDescription.value).toBe('Macarrão ao molho branco, fughi e cheiro verde das montanhas.');
    ...
    it('should be able to edit a food plate', async () => {
        ...
        expect(inputDescription.value).toBe('Macarrão com pimentão, ervilha e ervas finas colhidas no himalaia.');
